    ...
    public function execute() {
        ...
        if ($_POST['type'] === 'Insättning') {
            ...
            try {
                ...
                $this->kundRepository->depositWithkortnummer(
                    (int)$account,
                    (float)$amount
                );

                $messageToUser = "Insättning lyckades!";
            } catch (Exception $e) {
                $messageToUser = "Fel vid insättning: " . $e->getMessage();
            }
...
<main>
    ...
    <div class="container">
        ...
        <form class="form" method="post">
            ...
            <button type="submit" name="type" value="Insättning">Sätt in</button>
