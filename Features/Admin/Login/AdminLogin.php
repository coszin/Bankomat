...
<html lang="en">
    ...
    <body>
        <header>
            ...
            <div class="container">
            <img src="/Bankomat/Shared/Img/BankSöderLogoTop.png" alt="Söder logo" class="logo">
            </div>
        </header>   
        <main>
            ...
            <div class="container">
                <form class="form" method="post">
                    ...
                    <input type="text" pattern="[0-9]*" placeholder="Enbart number" name="kortnummer" value="<?php echo htmlspecialchars($_POST['kortnummer'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                    
                    <label for="PIN-kod">PIN-kod:</label>
                    <input type="text" pattern="[0-9]*" placeholder="Enbart number" name="pinkod" value="<?php echo htmlspecialchars($_POST['pinkod'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
